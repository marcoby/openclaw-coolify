...
// Build Repair Prompt
// ============================================================================
export function buildRepairPrompt(invalidContent, errors) {
...
export function validateSynthesis(content) {
    // Step 1: Parse JSON
    let raw;
    try {
    ...
    return { valid: true, parsed: synthesis };
}
// ============================================================================
// Generate Context Summary
// ============================================================================
export function generateContextSummary(inputs, synthesis) {
