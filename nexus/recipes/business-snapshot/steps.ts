...
import type { GuidedStep } from "../../types/recipe";

export const BUSINESS_SNAPSHOT_STEPS: GuidedStep[] = [
  {
    id: "q1",
 ...
 */
export function validateInputs(inputs: Record<string, unknown>): { valid: boolean; missing: string[] } {
