...
import { buildSynthesisPrompt, buildRepairPrompt, validateSynthesis, generateContextSummary, } from "./prompt";
import { generateNextActions } from "./next-actions";
// ============================================================================
// Recipe Definition
// ============================================================================
export const businessSnapshotRecipe = {
...
// Recipe Runner
// ============================================================================
export async function runBusinessSnapshot(ctx, rawInputs) {
    // 1. Validate inputs
...
async function callSynthesisWithRepair(inputs) {
    ...
    throw new Error(`Failed to generate valid synthesis after ${MAX_REPAIR_ATTEMPTS} repair attempts. ` +
