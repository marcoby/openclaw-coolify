...
import type { DecisionScope, VisibilityScope, LanguageMode } from "../types/context";
...
export interface DefaultRoleTemplate {
  id: string;  // used as suffix: role_ceo, role_ops-manager, etc.
  title: string;
...
export function initializeDefaultRoles(companyId: string): void {
...
export function getDefaultRoleTemplate(templateId: string): DefaultRoleTemplate | undefined {
...
export function getCeoRole(companyId: string): ReturnType<typeof getRolesForCompany>[0] | undefined {
